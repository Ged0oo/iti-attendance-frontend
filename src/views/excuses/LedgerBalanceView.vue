<template>
  <main class="flex-1 overflow-y-auto w-full relative">
    <div class="max-w-5xl mx-auto px-margin-mobile md:px-margin-desktop py-6 md:py-8 space-y-6 md:space-y-8">
      ...
      <section class="bg-surface rounded-[20px] p-6 md:p-8 shadow-[0_10px_15px_-3px_rgba(0,0,0,0.08),0_4px_6px_-2px_rgba(0,0,0,0.04)] relative overflow-hidden group">
      ...
      <section class="bg-surface rounded-2xl p-6 shadow-[0_4px_6px_-1px_rgba(0,0,0,0.05),0_2px_4px_-1px_rgba(0,0,0,0.03)]">
      ...
      <section class="pb-8">
        <button @click="openExcuseForm" class="w-full h-[52px] bg-primary-container text-white font-label rounded-lg shadow-[0_4px_6px_-1px_rgba(0,0,0,0.05),0_2px_4px_-1px_rgba(0,0,0,0.03)] hover:shadow-[0_10px_15px_-3px_rgba(139,26,26,0.12),0_4px_6px_-2px_rgba(139,26,26,0.08)] transition-all duration-300 flex items-center justify-center gap-2 active:scale-[0.99]">
